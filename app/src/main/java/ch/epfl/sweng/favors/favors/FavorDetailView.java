    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.favReportAbusiveAdd.setOnClickListener((l)->
                EmailUtils.sendEmail(
                        new Email(Authentication.getInstance().getEmail(), "report@myfavors.xyz", "Abusive favors : " + title.get(), "The abusive favor is : title" + title.get() + "\ndescription : " + description.get(), getActivity(), "issue has been reported! Sorry for the inconvenience", "Sorry an error occured, try again later...")));
        ...
        binding.interestedButton.setOnClickListener((l) -> {
            if (isItsOwn.get()) {
                ...
                if(interestedPeople.contains(User.getMain().getId())) {
                    ...
                    isInterested.set(true);
                    EmailUtils.sendEmail(
                            new Email(Authentication.getInstance().getEmail(), ownerEmail.get(), "Someone is interested in: " + title.get(), "Hi ! I am interested to help you with your favor. Please answer directly to this email.", getActivity(), "We will inform the poster of the add that you are interested to help!", "Sorry an error occurred, try again later..."));
